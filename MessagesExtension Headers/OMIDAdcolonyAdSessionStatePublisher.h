...
@protocol OMIDAdcolonyCommandPublisher;
@interface OMIDAdcolonyAdSessionStatePublisher : NSObject {

	id<OMIDAdcolonyCommandPublisher> _commandPublisher;
	unsigned long long _adState;
	double _timestamp;

}

@property (nonatomic,readonly) id<OMIDAdcolonyCommandPublisher> commandPublisher;              //@synthesize commandPublisher=_commandPublisher - In the implementation block
...
-(id<OMIDAdcolonyCommandPublisher>)commandPublisher;
