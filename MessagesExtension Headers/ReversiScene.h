...
@class NSMutableArray, SKNode, ReversiPiece, NSString, NSDate, NSMutableString, SKLabelNode, SKSpriteNode, ActionButton, TipNode, DotsLine, ReversiTip;
...
-(BOOL)showMoves:(int)arg1 add:(BOOL)arg2 ;
