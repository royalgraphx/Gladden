...
@class SKNode, SKSpriteNode, SKShapeNode, PoolPower, NSMutableArray, YouNode, NSMutableString, NSString, TipNode, PoolGlow, SKCropNode, PoolSkipButton, NSDate, SKAudioNode;
...
@interface PoolScene : GameScene {
	...
	float board_size;
	float board_size_h;
	PoolContactListener* listener;
	PoolGhostContactListener* listener2;
	SKNode* table;
	SKSpriteNode* board;
