...
@property (assign,nonatomic,__weak) id<MPImageLoaderDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(id)init;
-(id<MPImageLoaderDelegate>)delegate;
-(void)setDelegate:(id<MPImageLoaderDelegate>)arg1 ;
@end
