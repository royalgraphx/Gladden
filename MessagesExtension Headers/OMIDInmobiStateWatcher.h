...
@property (assign,nonatomic,__weak) id<OMIDInmobiStateWatcherDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
+(id)getInstance;
-(double)deviceVolume;
...
-(id<OMIDInmobiStateWatcherDelegate>)delegate;
-(void)setDelegate:(id<OMIDInmobiStateWatcherDelegate>)arg1 ;
-(void)stop;
-(void)start;
