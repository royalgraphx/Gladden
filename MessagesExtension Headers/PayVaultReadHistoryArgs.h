...
@property (assign) unsigned pageSize; 
@property (retain) NSString * targetUserId; 
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
+(id)payVaultReadHistoryArgsWithPage:(unsigned)arg1 pageSize:(unsigned)arg2 targetUserId:(id)arg3 ;
-(void)serializeToWriter:(id)arg1 sizeCacheId:(int)arg2 ;
-(void)deserializeFromReader:(id)arg1 ;
-(int)sizeWithCacheId:(int)arg1 ;
-(id)initWithPage:(unsigned)arg1 pageSize:(unsigned)arg2 targetUserId:(id)arg3 ;
-(NSString *)targetUserId;
