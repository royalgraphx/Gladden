...
@property (retain) NSMutableArray * requestData; 
@property (retain) NSMutableArray * requestRecipients; 
...
-(NSMutableArray *)requestRecipients;
-(void)setRequestRecipients:(NSMutableArray *)arg1 ;
-(id)init;
-(void)dealloc;
-(NSString *)requestType;
-(void)setRequestType:(NSString *)arg1 ;
-(void)setRequestData:(NSMutableArray *)arg1 ;
-(NSMutableArray *)requestData;
@end
