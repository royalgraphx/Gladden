...
@interface NotificationsToggleEndpointsArgs : NSObject <ProtobufMessage> {
...
+(id)notificationsToggleEndpointsArgsWithLastVersion:(id)arg1 endpoints:(id)arg2 enabled:(BOOL)arg3 ;
...
-(id)initWithLastVersion:(id)arg1 endpoints:(id)arg2 enabled:(BOOL)arg3 ;
-(id)init;
-(void)dealloc;
-(BOOL)enabled;
